...
'Claudia Puig':{'Snake on a Plane':3.5,'Just My Luck':3.0,'Superman Returns':4.0,
...
'Just My Luck':3.0,'Superman Returns':5.0,'You,Me,and Dupree':3.5,
'The Night Listener':3.0},
...
#calculate the sum of  product
    tSum=sum([prefs[p1][it]*prefs[p2][it] for it in si])
#calculate the sum of  squares
    sum1Sq=sum([pow(prefs[p1][it],2) for it in si])
    sum2Sq=sum([pow(prefs[p2][it],2) for it in si])
#calculate the Tanimoto similarity
    d=1-tSum/(sqrt(sum1Sq)+sqrt(sum2Sq)-tSum)
    return d
